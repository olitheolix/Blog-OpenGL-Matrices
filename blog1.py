...
class ViewerWidget(QtOpenGL.QGLWidget):
    ...
    def paintGL(self):
        ...
        # Define the triangle vertex positions.
        v_N_1 = np.array([-1.0, -1.0, 0])
        v_N_2 = np.array([+1.0, +0.0, 0])
        v_N_3 = np.array([-0.5, +0.5, 0])

        # v_N_1 = np.array([+1.0, -1.0, 0])
        # v_N_2 = np.array([+2.0, +0.0, 0])
        # v_N_3 = np.array([+1.5, +0.5, 0])

        # v_N_1 = np.array([-2.0, -1.0, 0])
        # v_N_2 = np.array([+2.0, +0.0, 0])
        # v_N_3 = np.array([-1.0, +0.5, 0])

        # v_N_1 = np.array([-1.0, -1.0, 0])
        # v_N_2 = np.array([+1.0, +0.0, 0.9])
        # v_N_3 = np.array([-0.5, +0.5, 0])

        # v_N_1 = np.array([-1.0, -1.0, 0])
        # v_N_2 = np.array([+1.0, +0.0, 1.1])
        # v_N_3 = np.array([-0.5, +0.5, 0])
